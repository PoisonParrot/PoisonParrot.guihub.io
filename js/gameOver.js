...
function gameOver(){
    ...
    for(var i = 1; i <= 16; i++){
        var piece_  = document.getElementById(i);
        if( piece_.innerHTML== ""){
            count++;
        }
    }
    ...
    if(count == 0){
        ...
        for(var i = 1; i <= 16; i++){
            var piece_self = document.getElementById(i);
            var piece_add_1 = document.getElementById(i + 1);
            var piece_cut_1 = document.getElementById(i - 1);
            var piece_add_4 = document.getElementById(i + 4);
            var piece_cut_4 = document.getElementById(i - 4);
            switch (i){
                case 1:
        ...
        if(count == 0){
            // 获取当前得分
            var score = document.getElementById("show_number").innerHTML;
